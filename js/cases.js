...
function spin() {
    ...
    setTimeout(() => {
        ...
        if (winningBox) {
            ...
            const weaponName = winningBox.querySelector('.box-normaltext').textContent.trim();
          
            const weaponQuality = winningBox.querySelector('span[class^="box-"]:not(.box-normaltext)').textContent.trim();
